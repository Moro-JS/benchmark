...
// MoroJS "Hello World" server (single thread) - matches Fastify benchmark methodology
//
...
const app = await createApp({
  server: {
    port: parseInt(process.env.PORT || '3110', 10), // createApp options outrank the PORT env var, so resolve it explicitly
    host: '127.0.0.1', // Default benchmark host (override with HOST env var)
  },
  performance: {
    clustering: {
      enabled: false, // Single-thread baseline
    },
  },
